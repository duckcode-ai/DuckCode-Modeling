...
2. Validate schema and rules: `./datalex validate model-examples/multi-model-demo/customers.model.yaml`.
3. Get model statistics: `./datalex stats model-examples/multi-model-demo/customers.model.yaml`.
