...
2. Validate schema and rules: `./datalex validate model-examples/multi-model-demo/orders.model.yaml`.
3. Get model statistics: `./datalex stats model-examples/multi-model-demo/orders.model.yaml`.
...
7. Resolve imports to verify cross-model references: `./datalex resolve model-examples/multi-model-demo/orders.model.yaml`.
