...
2. Validate schema and rules: `./datalex validate model-examples/real-scenarios/retail-analytics-baseline.model.yaml`.
3. Get model statistics: `./datalex stats model-examples/real-scenarios/retail-analytics-baseline.model.yaml`.
