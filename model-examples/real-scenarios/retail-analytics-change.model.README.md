...
2. Validate schema and rules: `./datalex validate model-examples/real-scenarios/retail-analytics-change.model.yaml`.
3. Get model statistics: `./datalex stats model-examples/real-scenarios/retail-analytics-change.model.yaml`.
...
7. Compare with baseline using gate: `./datalex gate model-examples/real-scenarios/retail-analytics-baseline.model.yaml model-examples/real-scenarios/retail-analytics-change.model.yaml`.
