...
2. Validate schema and rules: `./datalex validate model-examples/real-scenarios/fintech-risk-baseline.model.yaml`.
3. Get model statistics: `./datalex stats model-examples/real-scenarios/fintech-risk-baseline.model.yaml`.
