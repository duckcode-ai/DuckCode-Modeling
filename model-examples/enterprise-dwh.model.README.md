...
2. Validate schema and rules: `./datalex validate model-examples/enterprise-dwh.model.yaml`.
3. Get model statistics: `./datalex stats model-examples/enterprise-dwh.model.yaml`.
