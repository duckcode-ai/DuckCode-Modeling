...
2. Validate schema and rules: `./datalex validate model-examples/starter-commerce.model.yaml`.
3. Get model statistics: `./datalex stats model-examples/starter-commerce.model.yaml`.
